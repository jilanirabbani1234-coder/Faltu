    ...
    if data and data.get("success") and data.get("data"):
        ...
        if content_type in ("videos", "DppVideos"):
            ...
            if video_details:
                ...
                if vid:
                    api_url = f"https://api.penpencil.co/v1/videos/{vid}/signed-url"
            ...
            for content in contents:
                if content['contentType'] == 1:
                    ...
                    if url_val.endswith(("master.m3u8", "playlist.m3u8")) and url_val not in fetched_urls:
                        ...
                        headers2 = { 'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..ZTB77NTdTYHTR4ub4zFzxgSMdYw1APXbeQC7VflRMbNWkxjHYmxD1v1m_yyTKSJ9'}
...
async def cpwp_callback(bot, callback_query):
    ...
    await process_cpwp(bot, callback_query.message, user_id)
